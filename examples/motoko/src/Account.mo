...
actor class Account(payload : Types.InitPayload, _owner : Principal) = this{
  ...
  public func getAccountIdentifierBlobTextAndNat8Array() : async (Blob,Text,[Nat8]) {
    ...
    var accountIdentiierAsText = AccountIdLibraryHex.encode(Blob.toArray(accountIdentifierAsBlob));
    var accountIdentifierAsNat8Array = Blob.toArray(accountIdentifierAsBlob);
    return (accountIdentifierAsBlob,accountIdentiierAsText,accountIdentifierAsNat8Array);
  };
